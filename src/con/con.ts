...
export class Con extends Canvas {
  ...
  constructor(opt: any) {
    ...
    this._ttlEl = document.querySelector('.js-ttl')
  ...
  protected _update(): void {
    ...
    // だんだんタイトル出す
    if(Param.instance.isStart) {
      Tween.instance.set(this._ttlEl, {
        opacity:Util.instance.map(s, 0, 1, h * (Conf.instance.SCROLL_HEIGHT - 3), h * (Conf.instance.SCROLL_HEIGHT - 3) + h * 0.5)
      })
    }
